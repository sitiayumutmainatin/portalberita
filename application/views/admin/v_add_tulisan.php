...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url().'assets/plugins/select2/select2-bootstrap4-theme/select2-bootstrap4.css'?>">
  <link rel="stylesheet" href="<?php echo base_url().'assets/plugins/select2/select2-bootstrap4-theme/select2-bootstrap4.min.css'?>">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Post Gambar</h3>
            </div>
            <div class="box-body">
              ...
              <!-- Upload Gambar -->
               <div class="form-group">
                <label>Gambar</label>
                <input type="file" name="filefoto" value="<?php echo set_value('tulisan_gambar'); ?>" style="width: 100%;" required>
              </div>
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Post File</h3>
            </div>
            <div class="box-body">
              ...
              <!-- Upload File -->
               <div class="form-group">
                <label>File</label>
                <input type="file" name="filepdf" value="<?php echo set_value('tulisan_file'); ?>" style="width: 100%;" required>
              </div>
