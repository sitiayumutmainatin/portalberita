                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <!-- <a href="<?= base_url(); ?>tulisan/viewpdf/<?= $tulisan_file; ?>">Buka</a> -->
                            <a href="<?= base_url(); ?>admin/tulisan/viewpdf/<?= $tulisan_file; ?>">Buka</a>
                          </td>
        ...
        <div class="modal-content">
          ...
          <form class="form-horizontal" action="<?php echo base_url() . 'admin/tulisan/hapus_tulisan' ?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">
              ...
              <input type="hidden" value="<?php echo $tulisan_file; ?>" name="file">
